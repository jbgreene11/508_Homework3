...
View Local Moran's / feature in final_net for multiple P values
```{r}
final_net <-
  final_net %>% 
...
Create Reg.summary binding together observed & Predicted counts and errors for each grid cell for each regression with the CVID and geometry.
```{r}
reg.summary <- 
  rbind(
